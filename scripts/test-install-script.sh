...
missing = [name for name, (text, needle) in checks.items() if needle not in text]
if missing:
    raise SystemExit("v0.1.102 version fields missing or regressed: " + ", ".join(missing))
...
print("v0.1.102 version fields and release wiring: ok")
PY
...
checks = {
    ...
    "master v0.1.102": ("docs/progress/MASTER.md", "v0.1.102"),
    "master acceptance matrix": ("docs/progress/MASTER.md", "v0.1.102 Acceptance Matrix"),
...
if missing:
    raise SystemExit("v0.1.102 docs/static acceptance missing: " + ", ".join(missing))
...
print("v0.1.102 Linux WebUI/macOS Tauri docs: ok")
PY
