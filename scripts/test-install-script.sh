...
checks = {
    "README desktop Tauri entry": ("README.md", "Tauri App"),
    "README desktop LAN WebUI": ("README.md", "default-off, independently authenticated LAN WebUI"),
    ...
    "README desktop helper sync": ("README.md", "syncs it into the desktop data directory on launch"),
    "README macOS DMG": ("README.md", "NexusHub-<version>-darwin-arm64.dmg"),
    "README macOS tarball": ("README.md", "nexushub-darwin-arm64.tar.gz"),
    "README Linux Tauri AppImage": ("README.md", "NexusHub-<version>-Linux-x86_64.AppImage"),
    "README Linux Tauri deb": ("README.md", "NexusHub-<version>-Linux-x86_64.deb"),
    "README Linux Tauri rpm": ("README.md", "NexusHub-<version>-Linux-x86_64.rpm"),
    ...
    "runbook desktop boundary": ("docs/cloud-deploy-runbook.md", "Desktop Tauri Boundary"),
    ...
    "runbook Linux Tauri AppImage": ("docs/cloud-deploy-runbook.md", "NexusHub-<version>-Linux-x86_64.AppImage"),
    "runbook Linux Tauri deb": ("docs/cloud-deploy-runbook.md", "NexusHub-<version>-Linux-x86_64.deb"),
    "runbook Linux Tauri rpm": ("docs/cloud-deploy-runbook.md", "NexusHub-<version>-Linux-x86_64.rpm"),
    ...
    "README Linux updater platform": ("README.md", "linux-x86_64"),
    ...
    "runbook Linux updater platform": ("docs/cloud-deploy-runbook.md", "linux-x86_64"),
    "master signed updater": ("docs/progress/MASTER.md", "signed updater"),
    "master latest json": ("docs/progress/MASTER.md", "latest.json"),
    "master Linux Tauri AppImage": ("docs/progress/MASTER.md", "Linux-x86_64.AppImage"),
...
package_checks = {
    ...
    "LaunchServices stale DMG cleanup": "cleanup_stale_launchservices_dmg_registrations",
    "LaunchServices unregister stale NexusHub DMG apps": 'awk \'/path: *\\/Volumes\\/dmg\\..*\\/NexusHub\\.app/ {print $2}\'',
    "LaunchServices unregister command": '"${lsregister}" -u "${stale_app}"',
